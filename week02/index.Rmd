...
thm <- hc_theme(
  ...
  colors = c(maincolor, hc_theme_darkunica()$colors)
)
```
...
they were `r comma(sum(dft$n))` people and the `r  dft$pr[1]`%
(`r comma(dft$n[1])`) are in **California**. California is
followed by **New York**, **Florida** and **Texas** doing almost
the 50% of all homeless in U.S..
...
**Hawaii** and **New York**
presenting a slight increased trend. 
...
As we see in the chart the people so 
